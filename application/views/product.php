            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 mb-4 pb-2">
                    <div class="product-item d-flex flex-column align-items-center text-center bg-light rounded py-5 px-3">
                        ...
                        <a href="<?= base_url('user/cart') ?>" class="btn btn-sm btn-secondary">Pesan Sekarang</a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 mb-4 pb-2">
                    <div class="product-item d-flex flex-column align-items-center text-center bg-light rounded py-5 px-3">
                ...
                <div class="col-lg-3 col-md-6 mb-4 pb-2">
                    <div class="product-item d-flex flex-column align-items-center text-center bg-light rounded py-5 px-3">
                        ...
                        <h5 class="font-weight-bold mb-4">Chocolate Chips</h5>
                        <a href="<?= base_url('user/cart') ?>" class="btn btn-sm btn-secondary">Pesan Sekarang</a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 mb-4 pb-2">
                ...
                <div class="col-12 text-center">
                    <a href="<?= base_url('user/cart') ?>" class="btn btn-primary py-3 px-5">Muat Lainnya</a>
                </div>
            </div>
        </div>
    </div>
